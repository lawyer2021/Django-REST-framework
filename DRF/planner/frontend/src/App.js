...
// НЕ РАБОТАЕТ (ЗАПРОС С СЕРВЕРА ПО API ДАННЫХ ИЗ ТАБЛИЦЫ USERS):
...
// РАБОТАЕТ (РУЧНОЕ СОЗДАНИЕ ОБЪЕКТОВ):
// class App extends React.Component {
//     constructor(props) {
//         super(props)
...
// }
    ...
    // НЕ РАБОТАЕТ (ЗАПРОС С СЕРВЕРА ПО API ДАННЫХ ИЗ ВСЕХ ТАБЛИЦ - USERS, PROJECTS, TODO):
   // componentDidMount() {
    //     Promise.all([
    //     axios.get('http://127.0.0.1:8000/api/users'),
